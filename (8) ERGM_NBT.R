...
edges <- as.data.frame(as.edgelist(net_Q_NBT_clean))

edges$kin_relatedness <- get.edge.attribute(net_Q_NBT_clean, "kinship_coeff")
edges$distance <- get.edge.attribute(net_Q_NBT_clean, "Dyadic_distance")
...
QNBT_degree_plot <- barplot(deg_summary,
