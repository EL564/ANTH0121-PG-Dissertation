...
edges_support <- as.data.frame.network(net_Q_support, matrix.type = "edgelist") #88 dyadic observations
summary(net_Q_support) #summary of 155 dyadic observations
...
network.size(net_Q_support) #105 nodes in total
network.edgecount(net_Q_support) #250 edges in total
network.density(net_Q_support) #network density = 0.0531
